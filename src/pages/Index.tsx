...
const Index = () => {
  ...
  const specialists = [
    ...
    },
    {
      ...
      weight: 55,
      bust: 2,
      image: "https://cdn.poehali.dev/files/3.png"
    },
    {
      name: "Бэлла",
      age: 20,
      ...
      weight: 52,
      bust: 2,
      image: "https://cdn.poehali.dev/files/4.png"
    },
    {
      name: "Лиля",
      age: 21,
    ...
    },
    {
      ...
      weight: 53,
      bust: 2,
      image: "https://cdn.poehali.dev/files/6.png"
    },
    {
      name: "Натали",
      age: 23,
      ...
      weight: 52,
      bust: 2,
      image: "https://cdn.poehali.dev/files/7.png"
    },
    {
      name: "Алина",
      age: 23,
      ...
      weight: 46,
      bust: 1.5,
      image: "https://cdn.poehali.dev/files/8.png"
    },
    {
      name: "Мария",
      age: 22,
    ...
    },
    {
      ...
      weight: 62,
      bust: 2.5,
      image: "https://cdn.poehali.dev/files/11.jpg"
    },
    {
      name: "Яна",
      age: 21,
      ...
      weight: 55,
      bust: 4,
      image: "https://cdn.poehali.dev/files/12.jpg"
    },
    {
      name: "Ася",
      age: 22,
      ...
      weight: 56,
      bust: 2,
      image: "https://cdn.poehali.dev/files/13.png"
    },
    {
      name: "Мира",
      age: 30,
      ...
      weight: 60,
      bust: 3,
      image: "https://cdn.poehali.dev/files/14.png"
    },
    {
      name: "Юля",
      age: 30,
      ...
      weight: 70,
      bust: 2.5,
      image: "https://cdn.poehali.dev/files/15.png"
    },
    {
      name: "Карина",
      age: 25,
      ...
      weight: 50,
      bust: 2,
      image: "https://cdn.poehali.dev/files/16.png"
    },
    {
      name: "Кристина",
      age: 23,
      ...
      weight: 57,
      bust: 1.5,
      image: "https://cdn.poehali.dev/files/17.png"
    },
    {
      name: "Аня",
      age: 25,
      ...
      weight: 71,
      bust: 2.5,
      image: "https://cdn.poehali.dev/files/18.png"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b border-orange-600/20 bg-[#0a05018f]">
      ...
      <section id="hero" className="relative min-h-screen md:h-[660px] flex items-center justify-center px-8 md:px-16 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url(https://cdn.poehali.dev/projects/ef852a89-ba00-4a18-aa3f-8b9b570a09e5/files/890c23f8-0b4c-480a-9d6c-6e2efee647db.jpg)' }}
        ></div>
        <div 
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(to right, rgba(20, 7, 0, 0.5) 0%, rgba(20, 7, 0, 0.3) 50%, rgba(20, 7, 0, 0.5) 100%)'
          }}
        ></div>
        <div 
        ...
        <div className="relative z-10 max-w-3xl text-center space-y-8 animate-fade-in">
          <div className="inline-block text-white px-6 py-3 rounded-full text-sm md:text-base font-medium uppercase tracking-wider bg-[#805736a6]">
      ...
      <section className="py-12 px-6 bg-[#3d2817] border-y border-orange-600/20">
      ...
      <section id="milk-chocolate" className="relative py-24 px-6 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url(https://cdn.poehali.dev/files/673eca241114d8c6d14a6376_7-min.jpg)' }}
        ></div>
        <div 
      ...
      <section className="py-24 px-6 bg-[#0b0501]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-6 space-y-2">
            <h2 className="text-5xl md:text-6xl font-light text-foreground uppercase tracking-wide">
              Double Chocolate
      ...
      <section className="py-24 px-6 bg-[#0b0501]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-light text-foreground uppercase tracking-wide">
              ДОПОЛНИТЕЛЬНЫЕ SPA-ПРОГРАММЫ
            </h2>
          </div>
